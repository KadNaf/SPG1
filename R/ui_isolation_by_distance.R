...
isolation_by_distance_UI <- function(id) {
  ...
  fluidPage(
    ...
    tags$div(
      ...
      HTML(paste0(
        "<b>Option 1 — Use genetic and geographic distances computed internally:</b><br>",
        ...
        "<b>Option 2 — Import geographic distances from an external file:</b><br>",
        "Geographic distances can be imported from an <b>external Pop1/Pop2/Distance file</b>, ",
        "such as the subsample-pairs template exported by the <b>Subdivision</b> module and optionally edited manually."
      ))
    ),
        ...
        fluidRow(
          box(width = 4, solidHeader = TRUE, status = "primary",
            ...
            tags$p(style="color:#777;font-size:11px;",
              ...
              "Both use joint row/column relabelling, valid on incomplete data."),
