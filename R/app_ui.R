...
app_ui <- function() {
  ...
  custom_css <- shiny::HTML("
    ...
    /* --- New, additive-only rules for the expanded Help tab content.
       Nothing above/below this block was modified; these are new class
       names that don't touch any existing selector or app-wide theme. --- */
    .spg-help-nav {
    ...
    /* FAQ accordion (native details/summary — no JS dependency needed) */
    .spg-faq-item {
